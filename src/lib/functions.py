...
def removeStopWords(words):
	...
	'due', 'during', 'e', 'each', 'ed', 'edu', 'effect', 'eg', 'eight', 'eighty', 'either',\
	'else', 'elsewhere', 'end', 'ending', 'enough', 'especially', 'et', 'et-al', 'etc',\
	'even', 'ever', 'every', 'everybody', 'everyone', 'everything', 'everywhere', 'ex',\
	'except', 'f', 'far', 'few', 'ff', 'fifth', 'first', 'five', 'fix', 'followed',\
	'following', 'follows', 'for', 'former', 'formerly', 'forth', 'found', 'four', 'from',\
	'further', 'furthermore', 'g', 'gave', 'get', 'gets', 'getting', 'give', 'given',\
	'gives', 'giving', 'go', 'goes', 'gone', 'got', 'gotten', 'h', 'had', 'happens',\
	'hardly', 'has', "hasn't", 'have', "haven't", 'having', 'he', 'hed', 'hence', 'her',\
	'here', 'hereafter', 'hereby', 'herein', 'heres', 'hereupon', 'hers', 'herself', 'hes',\
	'hi', 'hid', 'him', 'himself', 'his', 'hither', 'home', 'how', 'howbeit', 'however',\
	'hundred', 'i', 'id', 'ie', 'if', "i'll", 'im', 'immediate', 'immediately',\
	...
	'thereby', 'thered', 'therefore', 'therein', "there'll", 'thereof', 'therere', \
	'theres', 'thereto', 'thereupon', "there've", 'these', 'they', 'theyd', "they'll", \
	'theyre', "they've", 'think', 'this', 'those', 'thou', 'though', 'thoughh', \
	'thousand',\
	'throug', 'through', 'throughout', 'thru', 'thus', 'til', 'tip', 'to', 'together', \
	'too', 'took', 'toward', 'towards', 'tried', 'tries', 'truly', 'try', 'trying', 'ts', \
	'twice', 'two', 'u', 'un', 'under', 'unfortunately', 'unless', 'unlike', 'unlikely', \
	'until', 'unto', 'up', 'upon', 'ups', 'us', 'use', 'used', 'useful', 'usefully', \
	'usefulness', 'uses', 'using', 'usually', 'v', 'value', 'various', "'ve", 'very', \
	'via','viz', 'vol', 'vols', 'vs', 'w', 'want', 'wants', 'was', "wasn't", 'way', 'we', \
	'wed', 'welcome', "we'll", 'went', 'were', "weren't", "we've", 'what', 'whatever', \
	"what'll", 'whats', 'when', 'whence', 'whenever', 'where', 'whereafter', 'whereas', \
	'whereby', 'wherein', 'wheres', 'whereupon', 'wherever', 'whether', 'which', 'while', \
	'whim', 'whither', 'who', 'whod', 'whoever', 'whole', "who'll", 'whom', 'whomever', \
	'whos', 'whose', 'why', 'widely', 'willing', 'wish', 'with', 'within', 'without', \
	"won't", 'words', 'world', 'would', "wouldn't", 'www', 'x', 'y', 'yes', 'yet', 'you', \
	'youd', "you'll", 'your', 'youre', 'yours', 'yourself', 'yourselves', "you've", 'z',\
	'zero', 'nbsp']
	for a in stop_words:
		while a in words:
			words.remove(a)
