...
def removeStopWords(words):
	...
	'''
	stop_words=['able', 'about', 'above', 'abroad', 'according', 'accordingly', 'across', 'actually',\
	'adj',\
	...
	"aren't", 'around', 'as', "a's", 'aside', 'ask', 'asking', 'associated', 'at', 'available', 'away',\
	'awfully', 'back', 'backward', 'backwards', 'be', 'became', 'because', 'become', 'becomes',\
	'becoming',\
	'been', 'before', 'beforehand', 'begin', 'behind', 'being', 'believe', 'below', 'beside',\
	'besides', 'best', 'better', 'between', 'beyond', 'both', 'brief', 'but', 'by', 'came', 'can',\
	'cannot', 'cant', "can't", 'caption', 'cause', 'causes', 'certain', 'certainly', 'changes', 'clearly',\
	 ...
	 "c's", 'currently', 'dare', "daren't", 'definitely', 'described', 'despite', 'did', "didn't",\
	 ...
	 'everyone', 'everything', 'everywhere', 'ex', 'exactly', 'example', 'except', 'fairly', 'far',\
	 'farther', 'few', 'fewer', 'fifth', 'first', 'five', 'followed', 'following', 'follows', 'for',\
	 'forever', 'former', 'formerly', 'forth', 'forward', 'found', 'four', 'from', 'further',\
	 'furthermore', 'get', 'gets', 'getting', 'given', 'gives', 'go', 'goes', 'going', 'gone', 'got',\
	 'gotten', 'greetings', 'had', "hadn't", 'half', 'happens', 'hardly', 'has', "hasn't", 'have',\
	 ...
	 'hopefully', 'how', 'howbeit', 'however', 'hundred', "i'd", 'ie', 'if', 'ignored', "i'll", "i'm",\
	 'immediate', 'in', 'inasmuch', 'inc', 'inc.', 'indeed', 'indicate', 'indicated', 'indicates',\
	 'inner',\
	 'inside', 'insofar', 'instead', 'into', 'inward', 'is', "isn't", 'it', "it'd", "it'll", 'its',\
	 ...
	 'might', "mightn't", 'mine', 'minus', 'miss', 'more', 'moreover', 'most', 'mostly', 'mr', 'mrs',\
	 'much', 'must', "mustn't", 'my', 'myself', 'name', 'namely', 'nd', 'near', 'nearly', 'necessary',\
	 'need', "needn't", 'needs', 'neither', 'never', 'neverf', 'neverless', 'nevertheless', 'new',\
	 'next', \
	 ...
	 'oh', 'ok', 'okay', 'old', 'on', 'once', 'one', 'ones', "one's", 'only', 'onto', 'opposite', 'or',\
	 'other', 'others', 'otherwise', 'ought', "oughtn't", 'our', 'ours', 'ourselves', 'out', 'outside',\
